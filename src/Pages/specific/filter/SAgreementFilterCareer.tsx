...
const SAgreementFilterCareer = () => {
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch('http://localhost:8081/specifics/current/Desarrollo%20de%20Software');
...
export default SAgreementFilterCareer;